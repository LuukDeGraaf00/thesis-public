...
Any immovable entity can be made movable by attaching the \type{Velocity} component.

\paragraph{Systems}
Systems operate on all entities that match a specific set of components.
...
This allows for a variant-wise collection of entities, which most ECS implementations utilize to implicitly create performant vectorized code.
