...
With this in mind many programming languages allow for flexibility around the internal representation of datatypes, while preserving the type identity.
...
While computational efficient, the alternative of {\it packing} can be preferred for a smaller memory footprint.  
