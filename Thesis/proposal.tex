...
Array languages such as APL\cite{apl}, Accelerate\cite{accelerate} and Futhark\cite{futhark-sum-types} can operate on a higher abstraction level compared to general-purpose languages through collective operations. 
The abstraction can be used to implicitly execute instructions in parallel, on multiple elements within an array. 
...
In contrast to inheritance, where relations are statically determined and game-logic is embedded within a predetermined hierarchy.
