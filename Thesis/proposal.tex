...
With this in mind many high performance programming languages allow for flexibility around the internal representation of datatypes, while preserving behavior and type identity.
This makes profiling ergonomically attractive due to the simplicity of which the foundation of a program can be changed. 
Within this chapter existing implementations that include such dynamic will be discussed, within the context of high-performance computing.
...
A generic implementation requires (costless) abstraction on an index access and/or a way to apply functions independently of the representation while preserving vectorization opportunities.   
Switching between representations was an initial\footnote{Not anymore.} focal point of the experimental language {\it Jai}, a c-like programming language for games.

\paragraph{By reference} Remove/add form of indirection...

\paragraph{Strict/Laziness}
