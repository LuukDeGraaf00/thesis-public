...
input size for cache : small, large
memory representation : no deduplicate, deduplicate
(de)-construction : match, conditional, unconditional
input : split, sorted, grouped
