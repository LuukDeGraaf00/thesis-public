...
Accelerate uses the \type{Elt} class to map between surface types and the internal representation.
...
In Accelerate each primitive type in a tuple is spread out over multiple arrays, which means this type-family enables an Array of Struct representation.
